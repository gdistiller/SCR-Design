...
#plot realisations of the GA designs
#also get Enrm numbers

rm(list=ls())

setwd("~/Git/SCRDesign/15FoldScen/Cluster")
load("GAStrata1Pars.Rdata")

par(mfrow=c(1,2))
plot(mask, axes = T)
plot(GA4.Strata1Pars.40.list[[1]], add = T)

getEnrm(GA4.Strata1Pars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA4.Strata1Pars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA5.Strata1Pars.40.list[[1]], add = T, col = "blue")

getEnrm(GA5.Strata1Pars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA5.Strata1Pars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

rm(list=ls())

load("GAStrata2Pars.Rdata")

plot(mask, axes = T)
plot(GA4.Strata2Pars.40.list[[1]], add = T)

getEnrm(GA4.Strata2Pars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA4.Strata2Pars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA5.Strata2Pars.40.list[[1]], add = T)

getEnrm(GA5.Strata2Pars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA5.Strata2Pars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

load("GAAvgStrataPars.Rdata")

plot(mask, axes = T)
plot(GA4.AvgStrataPars.40.list[[1]], add = T)

getEnrm(GA4.AvgStrataPars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA4.AvgStrataPars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA5.AvgStrataPars.40.list[[1]], add = T)

getEnrm(GA5.AvgStrataPars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA5.AvgStrataPars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

load("GABothStrataPars.Rdata")

plot(mask, axes = T)
plot(GA4.BothStrataPars.40.list[[1]], add = T)

getEnrm(GA4.BothStrataPars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA4.BothStrataPars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA5.BothStrataPars.40.list[[1]], add = T)

getEnrm(GA5.BothStrataPars.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA5.BothStrataPars.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

load("GABothStrataParsMax.Rdata")

plot(mask, axes = T)
plot(GA4.BothStrataParsMax.40.list[[10]], add = T)

getEnrm(GA4.BothStrataParsMax.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA4.BothStrataParsMax.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA5.BothStrataParsMax.40.list[[10]], add = T)

getEnrm(GA5.BothStrataParsMax.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA5.BothStrataParsMax.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

#loading some proposed designs with higher ngen, to asses convergence
load("GAStrata1Parsc.Rdata")

par(mfrow=c(2,2))
plot(mask, axes = T)
plot(GA4.Strata1Parsc.40.list[[1]], add = T)

getEnrm(GA4.Strata1Parsc.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA4.Strata1Parsc.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA5.Strata1Parsc.40.list[[1]], add = T)

getEnrm(GA5.Strata1Parsc.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA5.Strata1Parsc.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA4.Strata1Parsc.40.list[[2]], add = T)

plot(mask, axes = T)
plot(GA5.Strata1Parsc.40.list[[2]], add = T)

load("GAStrata2Parsc.Rdata")

par(mfrow=c(2,2))
plot(mask, axes = T)
plot(GA4.Strata2Parsc.40.list[[1]], add = T)

getEnrm(GA4.Strata2Parsc.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA4.Strata2Parsc.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA5.Strata2Parsc.40.list[[1]], add = T)

getEnrm(GA5.Strata2Parsc.40.list[[1]], mask, Dens = 0.05, L0 = L01, sigma = 200)
getEnrm(GA5.Strata2Parsc.40.list[[1]], mask, Dens = 0.05/15, L0 = L02, sigma = 3000)

plot(mask, axes = T)
plot(GA4.Strata2Parsc.40.list[[2]], add = T)

plot(mask, axes = T)
plot(GA5.Strata2Parsc.40.list[[2]], add = T)
