#Aug 2026, process sim results for 15 fold scen, 500 reps
#filters out reps where se/est > 100, uses mag factor of ten fold
#excludes GA both (max-min) and other spacings not used
#new OS for cluster and grid 120, adds new LW 120 design
#reprocessing 2 stage results after changing to En2 for stage 2
...
load("15FoldScen/Cluster/Sims/40Traps/TwoStageResults40b.RData")

TwoStage40.red1 <- find.rogue(TwoStageb.40.results[,c(1:6)], mag = mag.factor, true = c(0.05, 2, 200))
TwoStage40.red2 <- find.rogue(TwoStageb.40.results[,c(7:12)], mag = mag.factor, true = c(0.05/15, 2/15, 3000))
...
load("15FoldScen/Cluster/Sims/120Traps/TwoStageResults120d.RData")

TwoStage120.red1 <- find.rogue(TwoStaged.120.results[,c(1:6)], mag = mag.factor, true = c(0.05, 2, 200))
TwoStage120.red2 <- find.rogue(TwoStaged.120.results[,c(7:12)], mag = mag.factor, true = c(0.05/15, 2/15, 3000))
