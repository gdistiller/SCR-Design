#July 2025, simulations to evaluate different proposed GA designs for 15 fold scen
...
GA4.S1.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G4S1, masklist = mask, raw = TRUE, numcores = 2)
GA5.S1.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G5S1, masklist = mask, raw = TRUE, numcores = 2)
GA4.S2.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G4S2, masklist = mask, raw = TRUE, numcores = 2)
GA5.S2.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G5S2, masklist = mask, raw = TRUE, numcores = 2)
GA4.Both.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G4Both, masklist = mask, raw = TRUE, numcores = 2)
GA5.Both.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G5Both, masklist = mask, raw = TRUE, numcores = 2)
GA4.BothMax.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G4BothMax, masklist = mask, raw = TRUE, numcores = 2)
GA5.BothMax.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$G5BothMax, masklist = mask, raw = TRUE, numcores = 2)

save.image("GAResults40.RData")
