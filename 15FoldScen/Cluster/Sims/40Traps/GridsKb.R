...
#have divided into three jobs, this one doing K = 7,8,9,10
...
Grid.600.K7.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K7.results <- Fit.models(Data.obj = Grid.600.K7.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Kb.RData")
...
Grid.600.K8.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K8.results <- Fit.models(Data.obj = Grid.600.K8.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Kb.RData")
...
Grid.600.K9.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K9.results <- Fit.models(Data.obj = Grid.600.K9.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Kb.RData")
...
Grid.600.K10.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K10.results <- Fit.models(Data.obj = Grid.600.K10.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Kb.RData")
