#31 Aug 2026, simulations to evaluate 2 stage designs for 15 fold scen, for 40 traps
#this uses En2 for stage 2 to generate the proposed designs
...
TwoStageb.40.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = GA2StageDesigns$`40 traps`, masklist = mask)
TwoStageb.40.results <- Fit.models(Data.obj = TwoStageb.40.Data, nrep = nreps, numcores = cores)

save.image("TwoStageResults40b.RData")
