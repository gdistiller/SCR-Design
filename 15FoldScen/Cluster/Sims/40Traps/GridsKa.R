...
#using a spacing of 600
#have divided into three jobs, this one doing K = 2,3,4,5,6
...
Grid.600.K2.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K2.results <- Fit.models(Data.obj = Grid.600.K2.Data, nrep = nreps, numcores = cores)
...
Grid.600.K3.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K3.results <- Fit.models(Data.obj = Grid.600.K3.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Ka.RData")
...
Grid.600.K4.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K4.results <- Fit.models(Data.obj = Grid.600.K4.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Ka.RData")
...
Grid.600.K5.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K5.results <- Fit.models(Data.obj = Grid.600.K5.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Ka.RData")
...
Grid.600.K6.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K6.results <- Fit.models(Data.obj = Grid.600.K6.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Ka.RData")
