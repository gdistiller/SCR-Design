#April 2026, simulations to evaluate lacework designs for 15 fold scen, for 40 traps
...
LW.40.Data <- Sim.data(scenario.df = scen, nreps = nreps, traplist = lwlist$`40 traps`, masklist = mask)
LW.40.results <- Fit.models(Data.obj = LW.40.Data, nrep = nreps, numcores = cores)
save.image("LWResults40.RData")
