#May 26, simulations to evaluate optimal spacing grid designs (2G) for 15 fold scen
#500 reps and uses 20 cores
#redoing to dbl check opt spacing of 700
...
save.image("OSGridsResults40b.RData")
