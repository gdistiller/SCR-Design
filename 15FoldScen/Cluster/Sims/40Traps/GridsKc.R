...
Grid.600.K11.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K11.results <- Fit.models(Data.obj = Grid.600.K11.Data, nrep = nreps, numcores = cores)
...
Grid.600.K12.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K12.results <- Fit.models(Data.obj = Grid.600.K12.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Kc.RData")
...
Grid.600.K13.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K13.results <- Fit.models(Data.obj = Grid.600.K13.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Kc.RData")
...
Grid.600.K14.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.40$`600 m`, masklist = mask)
Grid.600.K14.results <- Fit.models(Data.obj = Grid.600.K14.Data, nrep = nreps, numcores = cores)
save.image("GridResults40Kc.RData")
