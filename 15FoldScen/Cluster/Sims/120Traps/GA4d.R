...
G4.Both.Datad <- Sim.data(scenario.df = scen, nreps = 1, traplist = GA.designs.120$G4Both, masklist = mask)
G4.Both.resultsd <- Fit.models(Data.obj = G4.Both.Datad, nrep = nreps, numcores = cores)
save.image("GA4Results120d.RData")
