...
#version e is for both max strata pars
...
G5.BothMax.Datae <- Sim.data(scenario.df = scen, nreps = 1, traplist = GA.designs.120$G5BothMax, masklist = mask)
G5.BothMax.resultse <- Fit.models(Data.obj = G5.BothMax.Datae, nrep = nreps, numcores = cores)
save.image("GA5Results120e.RData")
