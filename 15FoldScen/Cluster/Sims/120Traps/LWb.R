#July 2026, simulations to evaluate lacework design for 15 fold scen, for 120 traps, without any radius
...
LWB.120.Data <- Sim.data(scenario.df = scen, nreps = nreps, traplist = lwlist$`120 trapsB`, masklist = mask)
LWB.120.results <- Fit.models(Data.obj = LWB.120.Data, nrep = nreps, numcores = cores)
save.image("LWBResults120.RData")
