#July 26, simulations to evaluate optimal spacing grid designs (2G) for 15 fold scen
...
Grid.1300.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs.120$`1300 m`, masklist = mask)
Grid.1300.results <- Fit.models(Data.obj = Grid.1300.Data, nrep = nreps, numcores = cores)

save.image("OSGridsResults120.RData")
