...
G4.BothMax.Datae <- Sim.data(scenario.df = scen, nreps = 1, traplist = GA.designs.120$G4BothMax, masklist = mask)
G4.BothMax.resultse <- Fit.models(Data.obj = G4.BothMax.Datae, nrep = nreps, numcores = cores)
save.image("GA4Results120e.RData")
