#Aug 2025, simulations to evaluate grid designs for 15 fold scen
...
Grid.800.results <- Fit.models(Data.obj = Grid.800.Data, nrep = nreps, numcores = 20)
save.image("GridsbResults40.RData")

Grid.1600.Data <- Sim.data(scenario.df = scen, nreps = 1, traplist = grid.designs$`Avg sigma`, masklist = mask)
Grid.1600.results <- Fit.models(Data.obj = Grid.1600.Data, nrep = nreps, numcores = 20)
save.image("GridsbResults40.RData")
