...
TwoStage.40 <- Two.stage.design(msk = mask, alltraps = trap.locs, L0 = L01, Sig = sigma1, Dens = D1, ntrps = nT, nfixed = nT/2, ngens = 500, nreps = nreps)

save.image("GA2Stage40.RData")
