...
#uses ngen = 300, to finish job sooner while 500 still running
...
TwoStage.120.list <- foreach (r = 1:nreps, .combine='c') %dopar% {Two.stage.design(msk = mask, alltraps = trap.locs, L0 = L01, Sig = sigma1, Dens = D1, ntrps = nT, nfixed = nT/2, ngens = 300)}

save.image("GA2Stage120c.RData")
