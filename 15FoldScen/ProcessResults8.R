...
#and this version increases the mag factor
...
Allresults_2 <- list("40 traps" = all_results_40_2, "120 traps" = all_results_120_2)
save(Allresults_2, file = "15FoldScen/AllResults2.RData")
