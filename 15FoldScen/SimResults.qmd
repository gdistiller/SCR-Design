...
plot(GA.designs$G4S1[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G4S2[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G4Avg[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G4Both[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G4BothMax[[5]], add = TRUE)
```
:::
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G5S1[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G5S2[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G5Avg[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G5Both[[5]], add = TRUE)
```
...
```{r, echo = FALSE, fig.align="left"}
plot(res.objs$`SCR Mask`)
plot(GA.designs$G5BothMax[[5]], add = TRUE)
```
:::
...
-   Not sure why there is some positive bias for strata 2 when using the GA4 algorithm with S2 values, similarly not sure why a handful of reps gave problems for estimates for S2. The data summary shows more spatial recaps and less singletons for S2 (wqith slightly lower n).
