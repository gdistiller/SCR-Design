...
#this job is for a GA4 design with F sigma
...
GA4.FSigma.results <- Check.design(scenario.df = scen, nreps = 1, traplist = GA.designs$`F4 Sigma`, masklist = mask, raw = TRUE, numcores = 10)

###################################

save.image("GA4FSigma.RData")
