...
#this job is for a GA4 design with both sets of pars and max = T
...
GA4.FSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$`Both4 (Max = T)`, masklist = mask, raw = TRUE, numcores = 10)

save.image("GA4BothMaxSigma.RData")
