...
#this job is for a GA5 design with M sigma
...
GA5.MSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$`M5 Sigma`, masklist = mask, raw = TRUE, numcores = 10)

save.image("GA5MSigma.RData")
