...
#this job is for a GA5 design with both sets of pars
...
GA5.Both.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$`Both5`, masklist = mask, raw = TRUE, numcores = 10)

save.image("GA5BothSigma.RData")
