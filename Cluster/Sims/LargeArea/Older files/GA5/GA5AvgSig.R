...
#this job is for a GA5 design with Avg sigma
...
GA5.AvgSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$`Avg5 Sigma`, masklist = mask, raw = TRUE, numcores = 10)

save.image("GA5AvgSigma.RData")
