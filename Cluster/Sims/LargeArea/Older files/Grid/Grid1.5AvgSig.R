...
#this job is for a grid design with 1.5 * Avg sigma
...
Grid.AvgSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = grid.designs$`1.5*Avg Sigma`, masklist = mask, 
                                    raw = TRUE, numcores = 10)

save.image("Grid15AvgSigma.RData")
