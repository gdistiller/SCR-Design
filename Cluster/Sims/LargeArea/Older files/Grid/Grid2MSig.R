...
#this job is for a grid design with 2 * M sigma
...
Grid.MSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = grid.designs$`2*M Sigma`, masklist = mask, 
                                    raw = TRUE, numcores = 10)

save.image("Grid2MSigma.RData")
