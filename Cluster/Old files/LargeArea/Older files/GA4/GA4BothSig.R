...
#this job is for a GA4 design with both sets of pars
...
GA4.Both.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$`Both4`, masklist = mask, raw = TRUE, numcores = 10)

save.image("GA4BothSigma.RData")
