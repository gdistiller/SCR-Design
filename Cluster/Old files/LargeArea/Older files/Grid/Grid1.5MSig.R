...
#this job is for a grid design with 1.5 * M sigma
...
Grid.MSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = grid.designs$`1.5*M Sigma`, masklist = mask, 
                                    raw = TRUE, numcores = 10)

save.image("Grid15MSigma.RData")
