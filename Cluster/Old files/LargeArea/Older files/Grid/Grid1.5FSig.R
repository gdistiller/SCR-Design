...
#this job is for a grid design with 1.5 * F sigma
...
Grid.FSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = grid.designs$`1.5*F Sigma`, masklist = mask, 
                                    raw = TRUE, numcores = 10)

save.image("Grid15FSigma.RData")
