...
GA5.FSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$`Both5 (Max = T)`, masklist = mask, raw = TRUE, numcores = 10)

save.image("GA5BothMaxSigma.RData")
