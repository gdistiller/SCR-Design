...
#this job is for a GA5 design with F sigma
...
GA5.FSigma.results <- Sim.designs(scenario.df = scen, nreps = 1, traplist = GA.designs$`F5 Sigma`, masklist = mask, raw = TRUE, numcores = 10)

save.image("GA5FSigma.RData")
